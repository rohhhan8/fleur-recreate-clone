        ...
        <section className="relative w-full h-screen bg-white flex flex-col overflow-hidden">
            ...
            <div className="w-full h-24 flex items-center justify-between px-8 md:px-12 z-50 font-secondary bg-white relative">
                ...
                <div className="flex items-center gap-6 md:gap-10 text-sm font-medium text-text-primary tracking-wide">
                    <MagneticWrapper className="hidden md:block"><span>Home</span></MagneticWrapper>
                    <MagneticWrapper className="hidden md:block"><span>Pages</span></MagneticWrapper>
                    ...
                    <MagneticWrapper className="hidden md:block"><span>Blog</span></MagneticWrapper>
                    <MagneticWrapper className="hidden md:block"><span>Shop</span></MagneticWrapper>
